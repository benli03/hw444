...
using Li_Benjamin_HW4.DAL;
using Li_Benjamin_HW4.Models;
...
String connectionString = "Server=tcp:sp23libenjaminhw3.database.windows.net,1433;Initial Catalog=sp23libenjaminhw4;Persist Security Info=False;User ID=MISAdmin;Password=Password123;MultipleActiveResultSets=True;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;";
